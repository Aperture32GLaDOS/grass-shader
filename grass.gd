...
func _ready() -> void:
	...
	multimesh.instance_count = 1024 * 1024
	var input_bytes = multimesh.buffer.to_byte_array()
	...
	var uniform_set := rd.uniform_set_create([uniform, tex_uniform], shader, 0)
